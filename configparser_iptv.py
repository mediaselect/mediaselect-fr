...
logging.basicConfig(
    filename=os.path.expanduser("~/.local/share/mediaselect-fr/logs/configparser.log"),
...
print(
    ...
    "Lors de la sélection des chaines pour vos recherches dans media-select.fr, "
...
while True:
    while True:
        iptv_provider = input(
            ...
            "~/.config/mediaselect-fr/iptv_providers). Par exemple, si votre fichier de configuration "
        ...
        cmd = "cd ~/.config/mediaselect-fr && ls iptv_providers/{iptv_provider}.ini".format(
    ...
    while True:
        ...
        cmd = "cd ~/.config/mediaselect-fr && ls iptv_providers/{iptv_backup}.ini".format(
    ...
    while True:
        ...
        cmd = "cd ~/.config/mediaselect-fr && ls iptv_providers/{iptv_backup_2}.ini".format(
...
with open("/home/" + user + "/.config/mediaselect-fr/iptv_select_conf.ini", "w") as conf:
