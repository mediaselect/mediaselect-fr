...
config_iptv_select.read(f"/home/{user}/.config/mediaselect-fr/iptv_select_conf.ini")
...
config_iptv_provider.read(
    f"/home/{user}/.config/mediaselect-fr/iptv_providers/{iptv_provider}.ini"
)
...
logs_dir = home / ".local/share/mediaselect-fr/logs"
...
if recorder == 1:
    ...
    cmd = [
        str(home / ".local/share/mediaselect-fr/.venv/bin/streamlink"),
