...
if recorder == 1:
    cmd = (
        ...
        "{title}_ffmpeg.ts >> ~/.local/share/mediaselect-fr/logs/infos_ffmpeg.ts "
    ...
    cmd = (
        ...
        ">> ~/.local/share/mediaselect-fr/logs/infos_vlc.log 2>&1".format(
    ...
    cmd = (
        ...
        "~/.local/share/mediaselect-fr/logs/infos_mplayer.log 2>&1".format(
    ...
    cmd = (
        ...
        ">> ~/.local/share/mediaselect-fr/logs/infos_streamlink.log 2>&1".format(
...
print(
    ...
    "~/.local/share/mediaselect-fr/logs/infos_{application}.log".format(
