...
logging.basicConfig(
    filename=os.path.expanduser("~/.local/share/mediaselect-fr/logs/check_channels.log"),
...
cmd = (
    "ls /home/"
    + user
    + "/.config/mediaselect-fr/iptv_providers/{iptv_provider}_original_m3ulinks.ini".format(
...
try:
    provider = stdout.decode("utf-8").split(".config/mediaselect-fr/")[1][15:-1]
except IndexError:
    provider = ""
...
with open(
    "/home/" + user + "/.config/mediaselect-fr/iptv_providers"
...
cmd = (
    "ls /home/" + user + "/.config/mediaselect-fr/iptv_providers/{iptv_provider}_junk.ini"
...
try:
    junk = stdout.decode("utf-8").split(".config/mediaselect-fr/")[1][15:-1]
except IndexError:
    junk = ""
...
if junk == iptv_provider + "_junk.ini":
    cmd = (
        "cp /home/{user}/.config/mediaselect-fr/iptv_providers/"
        "{iptv_provider}_junk.ini /home/{user}/.config/"
        "mediaselect-fr/iptv_providers/{iptv_provider}_junk_last.ini".format(
    ...
    cmd = (
        "touch /home/" + user + "/.config/mediaselect-fr/iptv_providers/"
...
with open(
    "/home/" + user + "/.config/mediaselect-fr/iptv_providers/" + iptv_provider + "_junk.ini",
    "w",
) as ini:
    ini.write("[CHANNELS]" + "\n")
...
cmd = (
    "ls /home/" + user + "/.config/mediaselect-fr/iptv_providers/"
...
try:
    file_junk = stdout.decode("utf-8").split(".config/mediaselect-fr/")[1][15:-1]
except IndexError:
    file_junk = ""
...
with open(
    "/home/" + user + "/.config/mediaselect-fr/iptv_providers/" + iptv_provider + ".ini", "w"
) as ini:
    ini.write("[CHANNELS]" + "\n")
    for line in lines:
