...
config_constants.read("/home/" + user + "/.config/mediaselect-fr/constants.ini")
...
logging.basicConfig(
    filename=os.path.expanduser("~/.local/share/mediaselect-fr/logs/fusion.log"),
...
for n in range(len(streams_best) - 1):
    ...
    cmd = (
        ...
        "{file_2}_s.ts -loglevel quiet >> ~/.local/share/mediaselect-fr/logs/"
