...
config_iptv_select.read("/home/" + user + "/.config/mediaselect-fr/iptv_select_conf.ini")
...
with open(
    "/home/" + user + "/.local/share/mediaselect-fr/info_progs.json", "r"
) as jsonfile:
    data = json.load(jsonfile)

try:
    with open(
        "/home/" + user + "/.local/share/mediaselect-fr/info_progs_last.json", "r"
    ) as jsonfile:
    ...
    while provider_rank < 5:
        ...
        if provider["iptv_provider"] != "" and iptv_provider_set is False:
            ...
            config_iptv_provider.read(
                "/home/"
                + user
                + "/.config/mediaselect-fr/iptv_providers/"
...
src = os.path.expanduser("~/.local/share/mediaselect-fr/info_progs.json")
dest = os.path.expanduser("~/.local/share/mediaselect-fr/info_progs_last.json")
