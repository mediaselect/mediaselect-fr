...
config_path = os.path.join("/home", user, ".config", "mediaselect-fr", "iptv_select_conf.ini")
try:
...
log_file = os.path.expanduser("~/.local/share/mediaselect-fr/logs/cron_launch_record.log")
...
log_dir = os.path.expanduser("~/.local/share/mediaselect-fr/logs")
...
info_progs_path = os.path.join("/home", user, ".local", "share", "mediaselect-fr", "info_progs.json")
info_progs_last_path = os.path.join("/home", user, ".local", "share", "mediaselect-fr", "info_progs_last.json")
    ...
    while provider_rank < 5:
        ...
        if provider.get("iptv_provider", "") != "" and iptv_provider_set is False:
            ...
            provider_cfg_path = os.path.join(
                "/home", user, ".config", "mediaselect-fr", "iptv_providers", provider["iptv_provider"] + ".ini"
            )
            try:
        ...
        if provider.get("iptv_backup", "") != "" and iptv_backup_set is False:
            ...
            backup_cfg_path = os.path.join(
                "/home", user, ".config", "mediaselect-fr", "iptv_providers", provider["iptv_backup"] + ".ini"
            )
            try:
        ...
        if provider.get("iptv_backup_2", "") != "" and iptv_backup_2_set is False:
            ...
            backup2_cfg_path = os.path.join(
                "/home", user, ".config", "mediaselect-fr", "iptv_providers", provider["iptv_backup_2"] + ".ini"
            )
            try:
