...
lines = [line for line in stdout.splitlines() if "mediaselect" in line]
...
print(
    ...
    "après cette heure sur le site media-select.fr. Pour les vidéos prévues pour "
...
print(
    ...
    "l'application web media-select.fr dans la page 'mes enregistrements "
    "programmés'): \n"
)
