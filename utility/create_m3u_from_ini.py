...
try:
    with open(
        "/home/{user}/.config/mediaselect-fr/iptv_providers/{provider}.ini".format(
    ...
    print(
        ...
        "~/.config/mediaselect-fr/iptv_providers. Vous devez renseigner "
...
try:
    with open(
        "/home/{user}/.config/mediaselect-fr/iptv_providers/{m3u_file}.m3u".format(
    ...
    print(
        ...
        "~/.config/mediaselect-fr/iptv_providers. Vous devez renseigner comme "
