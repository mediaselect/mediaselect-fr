...
while (
    ...
    cmd = (
        "ls /home/"
        + user
        + "/.config/mediaselect-fr/iptv_providers/{m3u_file}.m3u".format(m3u_file=m3u_file)
    )
    ...
    if (
        ...
        print(
            ...
            " dossier ~/.config/mediaselect-fr/iptv_providers. Insérer "
...
cmd = (
    "du -h /home/" + user + "/.config/mediaselect-fr/iptv_"
...
if answer.lower() == "oui":
    with open(
        "/home/" + user + "/.config/mediaselect-fr/iptv_providers/" + m3u_file + ".m3u", "r"
    ) as m3u:
...
with open(
    "/home/" + user + "/.config/mediaselect-fr/iptv_providers/" + m3u_file + ".m3u", "w"
) as m3u:
    for line in lines:
        m3u.write(line)
