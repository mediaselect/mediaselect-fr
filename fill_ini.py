...
def search_url(channels, m3u_file):
    ...
    for chan in channels:
        with open(
            "/home/" + user + "/.config/mediaselect-fr/iptv_providers/" + m3u_file + ".m3u",
            "r",
        ) as m3u:
            for link in m3u:
                if match is True:
...
if __name__ == "__main__":
    ...
    while ls_result != (
        ...
        cmd = (
            "ls /home/" + user + "/.config/mediaselect-fr/iptv_providers/{m3u_file}.m3u"
        ...
        if ls_result != (
            ...
            print(
                ...
                " dossier ~/.config/mediaselect-fr/iptv_providers. "
    ...
    if (
        ...
        with open("/home/" + user + "/.local/share/mediaselect-fr/urls.txt", "a") as file:
    ...
    print(
        ...
        "toutes les chaînes présentes dans media-select.fr . La durée pour "
