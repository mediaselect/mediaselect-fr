...
print(
    ...
    "disponibles dans media-select.fr et votre fournisseurs d'IPTV.\n"
...
try:
    with open("/home/" + user + "/.local/share/mediaselect-fr/urls.txt") as file:
...
if manual == "non" or url_provider == "":
    ...
    while "channel_id" not in url_provider:
        ...
        if automate.lower() == "oui" or automate.lower() == "":
            ...
            ls_result = "abcdef"
            while ls_result != (
                "/home/" + user + "/.config/mediaselect-fr/"
                ...
                cmd = ("ls ~/.config/mediaselect-fr/iptv_providers/{m3u_file}.m3u").format(
                ...
                if ls_result != (
                    "/home/" + user + "/.config/mediaselect-fr/iptv"
...
cmd = (
    "ls /home/" + user + "/.config/mediaselect-fr/iptv_providers/{iptv_provider}.ini"
...
if ls_result == (
    "/home/" + user + "/.config/mediaselect-fr/iptv_providers/" + iptv_provider + ".ini"
):
    cmd = (
        "cp /home/" + user + "/.config/mediaselect-fr/iptv_providers/"
        "{iptv_provider}.ini /home/" + user + "/.config/mediaselect-fr/iptv_"
...
cmd = (
    ...
    "/mediaselect-fr/iptv_providers/{iptv_provider}.ini"
).format(iptv_provider=shlex.quote(iptv_provider))
...
cmd = (
    "cp /home/" + user + "/.config/mediaselect-fr/iptv_providers"
    "/{iptv_provider}.ini /home/" + user + "/.config/mediaselect-fr"
