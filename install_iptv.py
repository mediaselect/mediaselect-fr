...
lines = []
urls_txt = home / ".local" / "share" / "mediaselect-fr" / "urls.txt"
...
if manual == "non" or url_provider == "":
    ...
    while "channel_id" not in url_provider:
        ...
        if automate == "oui" or automate == "":
            ...
            config_dir = (home / ".config" / "mediaselect-fr" / "iptv_providers").resolve()
...
# ---------------------------
base = home / ".config" / "mediaselect-fr" / "iptv_providers"
