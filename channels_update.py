...
try:
    ...
    print(
        ...
        "~/.config/mediaselect-fr/iptv_providers. Veuillez créer ce fichier en exécutant le "
...
if not crypt or args.encrypted == "not_encrypted":
        ...
        while modify == "oui":
            ...
            while not match:
                channel = input(
                    ...
                    "correspondre au nom d'une chaine présente dans media-select.fr): "
                )
    ...
    try:
        ...
        print(
            ...
            "pas présent dans le dossier ~/.config/mediaselect-fr/iptv_providers. "
            "Veuillez créer ce fichier en exécutant le "
    ...
    try:
        ...
        print(
            ...
            "le dossier ~/.config/mediaselect-fr/iptv_providers. "
            "Veuillez créer ce fichier en exécutant le "
            "script fill_ini.py.".format(iptv_provider=args.iptv_provider)
        )
        exit()
        ...
        while modify == "oui":
            ...
            while not match:
                channel = input(
                    "\nQuel est le nom de la chaine dont vous voulez modifier "
                    "l'identifiant? (remarque: le nom doit exactement "
                    "correspondre au nom d'un chaine présente dans media-select.fr).: "
                )
                for line in lines_original:
                    try:
                        chan_url = line.split(" = ")
