...
base_path = os.path.join("/home", user, ".config", "mediaselect-fr", "iptv_providers")
...
if not ensure_owned_by_user(original_path):
    print(
        ...
        "~/.config/mediaselect-fr/iptv_providers. Veuillez créer ce "
...
if args.backup_2 != "no_backup_2":
    ...
    print(
        ...
        "{backup} et {backup_2} diffusent tous les 3 parmis les chaines d'MEDIA-select.fr. "
        "Voici la listes des chaines pour effectuer vos recherches dans "
        "le site web media-select.fr: \n".format(
    ...
    print(
        ...
        "{backup} diffusent tous les 2 parmis les chaines d'MEDIA-select.fr. "
        "Voici la listes des chaines pour effectuer vos recherches dans "
        "le site web media-select.fr: \n".format(
